...
type WaveShapedCanvasProps = {
  fillStyle: string;
};

/**
 * Wave Shaped Canvas component used to draw shape curved to top.
 */
const WaveShapedCanvas: React.FunctionComponent<WaveShapedCanvasProps> = ({
  fillStyle,
}) => {
