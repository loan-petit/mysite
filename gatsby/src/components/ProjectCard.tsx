      ...
      >
        ...
        >
          <Link to={url}>
            ...
            <h2 className='absolute inset-0 flex items-center justify-center w-full h-full text-white'>
              {project.title}
            </h2>
          </Link>
        </header>
        ...
        <div className='flex items-center w-full h-full bg-gray-100 rounded-lg md:w-3/5'>
          ...
          <div className='p-12 md:px-16'>
            <p>{project.excerpt}</p>
            <Link
              className='flex mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900'
              to={url}
            >
              Learn more
            </Link>
